# clash-mihomo-rules
原链接
原始链接: [https://raw.githubusercontent.com/biliperson/clash-mihomo-rules/refs/heads/main/clash/gemini.yaml]
...
[https://testingcf.jsdelivr.net/gh/]{用户名}/{仓库名}@{分支名}/{文件相对路径}
...
转换的规则:
直接在原完整链接前方拼接代理网址：
[https://ghproxy.net/]{原始完整 GitHub URL}
